...
const styles = StyleSheet.create({
  ...
  resultCard: { marginBottom: 26, marginHorizontal: 0, overflow: 'hidden' },
  resultCardHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 18,
  ...
  metricValue: { fontSize: 16, fontWeight: '700', marginBottom: 8 },
  metricLabel: { fontSize: 12, fontWeight: '600', textAlign: 'center', paddingHorizontal: 4 },
  saveBtnFull: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
